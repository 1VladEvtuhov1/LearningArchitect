...
**Митигация:** asmdef по плану `03_UNITY_MODULES.md`, но **после** стабилизации папок (TD-007); не дублировать `InterviewArena.*` вне `Assets/Modules/InterviewArena/`.
...
- `Assets/Modules/InterviewArena/` + `LocalArenaVariant` prefab  
