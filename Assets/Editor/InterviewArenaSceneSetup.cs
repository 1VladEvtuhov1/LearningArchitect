...
namespace LearningArchitect.EditorTools
{
    ...
    {
        private const string HubPrefabPath = "Assets/Showcase/Prefabs/ArchitectureShowcaseHub.prefab";
        ...
        private const string PlayerConfigPath = "Assets/Modules/InterviewArena/Data/InterviewArena_PlayerConfig.asset";
        private const string MeleeConfigPath = "Assets/Modules/InterviewArena/Data/InterviewArena_MeleeWeapon.asset";
        private const string CrossbowConfigPath = "Assets/Modules/InterviewArena/Data/InterviewArena_CrossbowWeapon.asset";
        private const string EnemyCrossbowConfigPath = "Assets/Modules/InterviewArena/Data/InterviewArena_EnemyCrossbowWeapon.asset";
        private const string BoltPrefabPath = "Assets/Modules/InterviewArena/Prefabs/InterviewArena_CrossbowBolt.prefab";
        private const string EnemyConfigPath = "Assets/Modules/InterviewArena/Data/InterviewArena_EnemyConfig.asset";
        private const string EnemyPrefabPath = "Assets/Modules/InterviewArena/Prefabs/InterviewArena_HollowSoldier.prefab";
        private const string PlayerPrefabPath = "Assets/Modules/InterviewArena/Prefabs/InterviewArenaPlayer.prefab";
        ...
        public static void EnsureScene()
        {
            ...
            EnsureFolder("Assets/Modules", "InterviewArena");
            EnsureFolder("Assets/Modules/InterviewArena", "Data");
            EnsureFolder("Assets/Modules/InterviewArena", "Scenes");
            ...
            BuildSceneUi(roots.Ui, out Transform hudDynamicRoot);
        ...
        {
            EnsureFolder("Assets/Modules", "InterviewArena");
            EnsureFolder("Assets/Modules/InterviewArena", "Prefabs");
            EnsureFolder("Assets/Modules/InterviewArena", "Data");
        ...
        public static void WireScenePlayerFromPrefab()
        {
            ...
            if (playerHealth != null)
                WirePlayerIframeHud(playerHealth);
        ...
        private static void WirePlayerIframeHud(Health playerHealth)
        {
            PlayerIframeHud hud = UnityEngine.Object.FindFirstObjectByType<PlayerIframeHud>();
        ...
        private static void CreatePlayerIframeHud(Transform canvasParent)
        {
            ...
            SerializedObject hudSerialized = new SerializedObject(host.GetComponent<PlayerIframeHud>());
        ...
        private static void BuildSceneUi(Transform uiRoot, out Transform hudDynamicRoot)
        {
            ...
            CreatePlayerIframeHud(hudCanvasObject.transform);
