...
namespace LearningArchitect.Tests.Core
{
    ...
    {
        private const string ExpectedMessage = "Showcase layout rebuild is deprecated and disabled. Use Assets/Showcase/Prefabs/ArchitectureShowcaseHub.prefab as the source of truth, or inspect Assets/Showcase/Prefabs/Archive/ArchitectureShowcaseHub_LegacyArchive.prefab as an archived baseline until a new explicit tool is designed.";
