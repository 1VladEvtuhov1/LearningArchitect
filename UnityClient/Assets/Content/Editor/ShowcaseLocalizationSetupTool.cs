...
namespace LearningArchitect.EditorTools
{
    ...
    {
        private const string RootFolder = "Assets/Content/Showcase/Localization";
        private const string LocalesFolder = "Assets/Content/Showcase/Localization/Locales";
        private const string TablesFolder = "Assets/Content/Showcase/Localization/Tables";
        private const string SettingsPath = "Assets/Content/Showcase/Localization/ShowcaseLocalizationSettings.asset";
        private static readonly string[] DefinitionSearchFolders =
        {
            "Assets/Content/Showcase/Data",
