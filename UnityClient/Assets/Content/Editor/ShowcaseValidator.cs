    ...
    public static class ShowcaseValidator
    {
            ...
            ShowcaseLocalizationSnapshot localization)
        {
            ...
            if (modules == null || modules.Count == 0)
                report.AddError("No module definitions were found under Assets/Content/Showcase/Data or Assets/Content/Modules.", null);

            if (variants == null || variants.Count == 0)
                report.AddError("No variant definitions were found under Assets/Content/Showcase/Data or Assets/Content/Modules.", null);
