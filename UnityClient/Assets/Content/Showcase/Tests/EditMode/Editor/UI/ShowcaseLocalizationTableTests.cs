...
namespace LearningArchitect.Tests.UI
{
    ...
    {
        private const string EnglishTablePath = "Assets/Content/Showcase/Localization/Tables/ShowcaseContent_en.asset";
        private const string RussianTablePath = "Assets/Content/Showcase/Localization/Tables/ShowcaseContent_ru.asset";
        private const string EffectsModulePath = "Assets/Content/Modules/EffectsSystem/Data/EffectsModule.asset";
        private const string ChunkVariantPath = "Assets/Content/Modules/EffectsSystem/Data/Effects_ChunkVariant.asset";
