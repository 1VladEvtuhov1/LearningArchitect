...
namespace LearningArchitect.Modules.InterviewArena
{
    ...
    public sealed class CombatHitFeedback : MonoBehaviour
    {
        ...
        public static void PlayBlock(in DamageInfo info)
        {
            if (instance == null)
                return;
        ...
        public static void PlayCrossbowFire(Transform muzzle)
        {
            ...
            PlayCrossbowFire(muzzle.position, muzzle.forward);
        }

        public static void PlayCrossbowFire(Vector3 position, Vector3 direction)
        {
            if (instance == null)
                return;
        ...
        public static void PlayCrossbowFireAt(Vector3 position, Vector3 direction) =>
            PlayCrossbowFire(position, direction);
