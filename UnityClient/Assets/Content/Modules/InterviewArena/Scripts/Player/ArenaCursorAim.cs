...
namespace LearningArchitect.Modules.InterviewArena
{
    ...
    public sealed class ArenaCursorAim : MonoBehaviour
    {
        ...
        /// <summary>Edit Mode / tooling: inject planar aim without a camera raycast.</summary>
        public void SetAimDirectionForTests(Vector3 planarDirection)
        {
            planarDirection.y = 0f;
            AimDirection = planarDirection.sqrMagnitude > 0.0001f
