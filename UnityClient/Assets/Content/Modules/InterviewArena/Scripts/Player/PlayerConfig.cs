...
namespace LearningArchitect.Modules.InterviewArena
{
    ...
    public sealed class PlayerConfig : ScriptableObject
    {
        ...
        [Tooltip("Middle fraction of dash duration that absorbs normal attacks.")]
        [SerializeField] [Range(0f, 1f)] private float dashIframeCoverage = 0.85f;
        ...
        [Tooltip("Half-angle of the frontal block cone, degrees.")]
        [SerializeField] private float blockConeHalfAngleDegrees = 70f;
        [Tooltip("Local delay after death before restoring at spawn.")]
        ...
        public float DashIframeCoverage => Mathf.Clamp01(dashIframeCoverage);
        ...
        public float BlockConeHalfAngleDegrees =>
            Mathf.Clamp(blockConeHalfAngleDegrees, 1f, 179f);
        public float RespawnDelay => Mathf.Max(0.1f, respawnDelay);
    }
}
