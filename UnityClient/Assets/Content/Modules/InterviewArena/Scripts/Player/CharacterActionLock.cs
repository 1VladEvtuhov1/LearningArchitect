...
namespace LearningArchitect.Modules.InterviewArena
{
    public readonly struct CharacterActionLock
    {
        ...
        public static CharacterActionLock Block() =>
            new(CharacterActionKind.Block, remainingSeconds: 0.35f,
                blocksMovement: true,
                blocksTurning: false,
                blocksAttack: true,
                blocksDash: false,
        ...
        public static CharacterActionLock CrossbowFire(
            float remainingSeconds,
            bool inMovementLock) =>
            new(CharacterActionKind.CrossbowFire, remainingSeconds,
                blocksMovement: inMovementLock,
                blocksTurning: false,
                blocksAttack: true,
                blocksDash: true,
                blocksJump: true);
