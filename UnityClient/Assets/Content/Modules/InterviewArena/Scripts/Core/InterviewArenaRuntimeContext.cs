    ...
    public sealed class InterviewArenaRuntimeContext : MonoBehaviour
    {
        ...
        public Result TryWirePlayerAndCamera()
        {
            ...
            if (playerHealthHud == null)
                missing.Add(nameof(playerHealthHud));
        ...
        private void WirePlayerHealthHud()
        {
            ...
            playerHealthHud.BindPlayerHealth(health);
        }
        ...
        {
            PlayerDeathController death = player.GetComponent<PlayerDeathController>();
            if (death == null)
            {
                InterviewArenaAuthoringLog.MissingReference(player, nameof(PlayerDeathController));
                return;
            }

            death.ApplyConfig(playerConfig, arenaFloorCollider);
            death.CaptureSpawnPose();
        }
