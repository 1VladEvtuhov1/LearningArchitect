...
namespace LearningArchitect.Modules.InterviewArena
{
    ...
    public sealed class InterviewArenaSceneUI : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            InterviewArenaRunSession.PlayerDied += HandlePlayerDied;
            InterviewArenaRunSession.PlayerRespawned += HandlePlayerRespawned;
            RefreshLabels();
        }
        ...
        private void HandlePlayerDied()
        {
            ...
            subtitleLabel.text = ShowcaseLocalizationContent.GetText(
                ResolveLanguage(),
                "interview_arena_player_died");
        }
