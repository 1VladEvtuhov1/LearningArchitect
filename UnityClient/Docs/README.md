# LearningArchitect Docs (UnityClient)
...
1. `../README.md` (Unity client entry)
2. `../../README.md` (product workspace)
3. `Architecture.md`
4. `HubAndCarrierAuthoring.md`
...
- `Modules/InterviewArena/README.md`
  - Interview Arena module; full spec under `Modules/InterviewArena/docs/`.
...
- `ModuleDefinitionSO` / `VariantDefinitionSO` under `Assets/Content/Modules/*/Data` hold **`localizationKey`**, taxonomy, prefab references, and stress counts only — not duplicate EN/RU strings. Details: `Architecture.md`.
