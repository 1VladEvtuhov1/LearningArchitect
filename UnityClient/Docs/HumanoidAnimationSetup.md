...
- `Assets/Content/Modules/LayeredCharacterAnimation/Models/Running.fbx`
...
- `Assets/Content/Modules/LayeredCharacterAnimation/Data/Animation_RunVariant.asset`
- `Assets/Content/Modules/LayeredCharacterAnimation/Data/Animation_ShootVariant.asset`
- `Assets/Content/Modules/LayeredCharacterAnimation/Data/Animation_RunShootVariant.asset`

The module asset `Assets/Content/Modules/LayeredCharacterAnimation/Data/Animation3DModule.asset` now references these three variants.
...
```text
Assets/Content/Editor/PaladinCombatAnimationSetup.cs
```
